...
export const ImplementerTable = () => {
  ...
  const getRequestsToImplement = async () => {
    ...
    try {
      await axios
        .get(
          `${apiURL}/GetAllAccessRequestByImplementerEmail?implementerEmail="email"@premiumtrustbank.com&implementerName=${name}&statusCode=0001`
        )
        .then((response) => {
        ...
        <div className="mb-4 flex flex-col justify-between gap-8 md:flex-row md:items-center">
          <div>
            ...
            <Typography color="gray" className="mt-1 font-normal">
              These are details on requests you are to implement.
            </Typography>
          </div>
