...
const ApprovedData = () => {
  ...
  const getApprovedDataByDateRange = () => {
    const url = `${apiURL}/GetDudChequeApprovedTransactionByDateRange`;
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                >
                  <thead className="bg-[#2B2E35] text-sm text-white font-semibold rounded-lg">
                    ...
                    <th className="p-4 hidden">Account Open Date</th>
                    ...
                    <th className="p-4 hidden">Issuer Date</th>
                    <th className="p-4 hidden">MICR Number</th>
                    <th className="p-4 hidden">Payee</th>
                    <th className="p-4 hidden">Set tlement Date</th>
                    <th className="p-4 hidden">SortCode</th>
                                ...
                                <ImDownload2
                                  ...
                                  onClick={() => {
                                    ...
                                    const rowData = {
                                      ...
                                      Payee: dud.Payee,
                                      Settled: dud.Settled,
                                      SettleDate: dud.SettleDate,
                                      SortCode: dud.SortCode,
                                      Initiator: dud.Initiator,
                                      InitiatorDate: dud.InitiatorDate,
                                      ApproverName: user.name,
                                      ApprovedDate: dud.ApprovedDate,
