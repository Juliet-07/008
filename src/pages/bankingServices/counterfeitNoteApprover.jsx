...
import ApprovedData from "./counterfeitNoteApprovedData";
import PendingData from "./counterfeitPendingData";

const CounterfeitNoteApprover = () => {
...
export default CounterfeitNoteApprover;
