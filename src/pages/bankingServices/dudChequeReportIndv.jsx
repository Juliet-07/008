...
const DudChequeReportIndv = () => {
  ...
  const getIndvDataByDateRange = () => {
    const url = `${process.env.REACT_APP_DUDCHEQUE}/GetIndvDudChequeByDataRange`;
  ...
  const exportToExcel = () => {
    const ws = XLSX.utils.json_to_sheet(indvDudCheque);
    const wb = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, "Individual DudChequeReport");
    ...
    <>
      <div className="flex flex-col items-center justify-center">
        {/* <div className="w-full rounded-lg bg-white p-4">
          <div className="flex flex-col items-center justify-center">
            <SummaryTableIndv branchData={indvDudCheque} />
            <nav>
              <ul className="flex flex-row items-center">
                <li>
                  <MdSkipPrevious
                    size={20}
                    onClick={prevPageCorp}
                    className="cursor-pointer"
                  />
                </li>
                {numbersCorp.map((n, i) => (
                  <li key={i} className="text-lg p-2">
                    <a href="#" onClick={() => changeCurrentPageCorp(nthpages)}>
                      {n}
                    </a>
                  </li>
                ))}
                            ...
                            <div className="my-4">
                              ...
                              <div className="flex items-center justify-center mt-4">
                                <button
                                  ...
                                  type="submit"
                                  className="w-[150px] h-10 p-2 text-white text-sm font-semibold rounded bg-green-600 hover:bg-green-300"
                                >
                                  Export to Excel
                                </button>
                                <button
                                  onClick={exportToPDF}
                                  type="submit"
                                  className="w-[150px] h-10 p-2 text-white text-sm font-semibold rounded bg-red-600 hover:bg-red-300 mx-4"
                                >
                                  Export to PDF
                                </button>
                              </div>
